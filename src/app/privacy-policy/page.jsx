    ...
    <div className="privacyPolicy fadeContent">
      ...
      <div className="policySection">
        ...
        <ul>
          ...
          <li>
            <strong>URLs</strong> used to access the Service (e.g., wisp.tools,
            www.wisp.tools, wisptools.vercel.app).
          </li>
          <li>
            <strong>Referrers</strong> (the website or link that directed you to
            Wisp).
          </li>
          <li>
          ...
          <li>
            <strong>Browser</strong> and <strong>operating system</strong> used.
          </li>
        </ul>
        <h3>Local Storage</h3>
        <p>
          Your <strong>favorite modules</strong> are stored <em>locally</em> on
          your browser via Local Storage. This data is <em>never</em>{" "}
      ...
      <div className="policySection">
        ...
        <p>
          ...
          information we collect is not personally identifiable or commercially
          valuable to third parties, and even if it was we would not choose to
          ever sell this information.
        </p>
      </div>
      ...
      <div className="policySection">
        ...
        <p>
          Wisp is fully open source. You may review, audit, or contribute to our
          codebase at{" "}
      ...
      <div className="policySection">
        ...
        <p>
          ...
          on this page with a revised <em>Effective Date</em>.
        </p>
      </div>
